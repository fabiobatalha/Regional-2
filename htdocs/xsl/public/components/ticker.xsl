...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:include href="default/ticker.xsl"/>
        ...
        <link rel="stylesheet" href="/css/public/skins/classic/common/carousel.css" type="text/css">
            <xsl:comment>BVS</xsl:comment>
        </link>

        <script type="text/javascript" src="/js/jsSlider/jquery.min.js">//</script>
        ...
        <script type="text/javascript">
            $(function(){
                $.unobtrusivelib();
                prettyPrint();
                $("div.pagination").carousel({ pagination: true, effect: "fade", autoSlide: true, loop: true, autoSlideInterval: 5000});
            });
        </script>
