...
<script type="text/javascript" src="/applications/scielo-org/js/metaSearch.js"></script>
<script type="text/javascript" src="<?=$def['DIRECTORY']?>js/jquery.js"></script>
<script type="text/javascript" src="<?=$def['DIRECTORY']?>js/iframe.js"></script>
