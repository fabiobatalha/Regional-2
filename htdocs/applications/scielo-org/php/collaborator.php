                ...
                <div class="middle">
                    ...
                    <div class="content">
                        ...
                        <ul>
                            ...
                            <li><a href="http://www.scielo.cl/stat_biblio/index.php?lang=<?=$lang?>&state=16" 6target="_blank">Chile</a></li>
                            <li><a href="http://www.scielosp.org/stat_biblio/index.php?lang=<?=$lang?>&state=16" target="_blank">Saúde Pública</a></li>
                        </ul>
                    </div>
		</div>
            </div>
